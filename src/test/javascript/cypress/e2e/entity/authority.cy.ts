...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '85f418c8-51b6-436a-900a-dd6539f8a87e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e8d60327-d772-4a7c-a54c-91fe8567a5e5');
      cy.get(`[data-cy="name"]`).should('have.value', 'e8d60327-d772-4a7c-a54c-91fe8567a5e5');
